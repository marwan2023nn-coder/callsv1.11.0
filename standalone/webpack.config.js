...
let mode = 'production';
let devtool = false;
const contentSecurity = 'default-src \'self\'; script-src \'self\'; style-src \'self\' \'unsafe-inline\'; img-src \'self\' data:; font-src \'self\'; connect-src \'self\' wss: ws:; object-src \'none\'';
